...
os.chdir(r"D:\\DEVANG NEW THINGS\XUS\\ULTIMATE PRICE PRIDICTION_NEW")
...
UPLOAD_FOLDER = 'static'  # Folder to save the plot images
...
def index():
    if request.method == 'POST':
        ...
        if train_split < 10 or train_split > 90:
            return "Error: Please enter a percentage between 10 and 90."
        ...
        try:
            ...
            for model_name, model in models.items():
                ...
                # Calculate the R2 score (accuracy) and RMSE
                accuracy = r2_score(y_test, y_pred) * 100  # R² score as percentage
